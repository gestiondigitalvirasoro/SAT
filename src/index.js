...
app.use((req, res, next) => {
  if (!req.session.user && (req.path === '/dashboard' || req.path === '/visitas' || req.path.startsWith('/reports') || req.path === '/nueva-visita' || req.path === '/nueva-empresa' || req.path === '/crear-visita')) {
    req.session.user = {
      id: 1,
